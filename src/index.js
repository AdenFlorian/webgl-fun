...
import {loadShaderFromServer, getColorForTime} from './utils.js'
...
async function main() {
  ...
  function renderLoop() {
    ...
    drawScene(gl, programInfo, buffers, mainCanvasElement)
 ...
 */
function drawScene(gl, programInfo, buffers, canvasElement) {
  gl.clearColor(...getColorForTime(Date.now() / 1000, 16))
